...
namespace FastColoredTextBoxNS
{
    public class SyntaxHighlighter : IDisposable
    {
        ...
        public readonly Style ForStrings = new TextStyle(new SolidBrush(Color.FromArgb(214, 157, 133)), null, FontStyle.Regular);
        public readonly Style ForComents = new TextStyle(new SolidBrush(Color.FromArgb(87, 166, 74)), null, FontStyle.Regular);
        public readonly Style ForNumbers = new TextStyle(new SolidBrush(Color.FromArgb(181, 206, 168)), null, FontStyle.Regular);
        public readonly Style ForClasses = new TextStyle(new SolidBrush(Color.FromArgb(78, 201, 176)), null, FontStyle.Regular);
        public readonly Style ForStatems = new TextStyle(new SolidBrush(Color.FromArgb(86, 156, 214)), null, FontStyle.Regular);
        ...
        protected void InitCShaprRegex()
        {
            ...
            CSharpClassNameRegex = new Regex(@"\b(class|struct|enum)\s+(?<range>\w+?)\b", RegexCompiledOption);

            CSharpKeywordRegex =
                new Regex(
                    @"\b(thread|string|auto|const|double|float|int|short|struct|unsigned|break|continue|else|for|long|signed|switch|void|case|default|enum|goto|register|sizeof|typedef|volatile|char|do|extern|if|return|static|union|while|asm|dynamic_cast|wchar_t|true|protected|mutable|delete|throw|public|inline|const_cast|using|this|private|friend|class|typename|template|operator|false|catch|typeid|static_cast|new|explicit|bool|try|reinterpret_cast|namespace)\b",
                    RegexCompiledOption);
        }
        ...
        public void InitStyleSchema(Language lang)
        {
            switch (lang)
            {
                case Language.CSharp:
                    ...
                    StringStyle = ForStrings;
                    CommentStyle = ForComents;
                    NumberStyle = ForNumbers;
                    AttributeStyle = GreenStyle;
                    ClassNameStyle = ForClasses;
                    KeywordStyle = ForStatems;
